...
for language in LANGUAGES:
    TRAINING_DATA.append(
        np.array([open('scraper/data/' + language + '/TRAINING_SET.db').read()])
    )

TRAINING_SET = np.concatenate([language for language in TRAINING_DATA])
...
joblib.dump(TDIDF_TRANSFORMER, 'tdidf_transformer.pkl')
